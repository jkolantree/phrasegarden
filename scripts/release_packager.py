...
CLOSED_SPEC_PATHS = {
    ...
    "preview7": ("artifacts/release/preview7-source-manifest.json",
                 "artifacts/release/preview7-package-stage",
    ...
    "preview8": ("artifacts/release/preview8-source-manifest.json",
                 "artifacts/release/preview8-package-stage",
    ...
    "preview9": ("artifacts/release/preview9-source-manifest.json",
                 "artifacts/release/preview9-package-stage",
    ...
    "preview10": ("artifacts/release/preview10-source-manifest.json",
                  "artifacts/release/preview10-package-stage",
...
def validate_release_specs(specs: Mapping[str, ReleaseSpec]) -> None:
    if tuple(specs) != (
        "preview3", "preview4", "preview5", "preview6", "preview7", "preview8",
        "preview9", "preview10",
    ):
    ...
    expected = (("preview3", "0.1.0-preview.3"),
                ...
                ("preview7", "0.1.0-preview.7"),
                ("preview8", "0.1.0-preview.8"),
                ("preview9", "0.1.0-preview.9"),
                ("preview10", "0.1.0-preview.10"))
    ...
    (preview3, preview4, preview5, preview6, preview7, preview8, preview9,
     preview10) = specs.values()
...
_preview7 = make_release_spec(
    "preview7", "0.1.0-preview.7",
    parent_ledger_binding=(1952,
        "82CBC32E5606F827765983271B248CD7C4788DFE57AB703FD1B94A55432B9C4E"),
    predecessor_bindings=(
        (_preview6.final_archive, 186851,
         "6A2DC1E364F42B64D54034E734233CB09A9166A01F9C6591D182AB40CA81EA55"),
        (_preview6.final_manifest, 976,
         "B9753A9286D3C8E662ABB7A9244817BFA7EAA2382B262794816527C765074F7E")),
)
_preview8 = make_release_spec(
    "preview8", "0.1.0-preview.8",
    parent_ledger_binding=(2188,
        "FE11EEA9DC696BC04FA63E7D9E56D95077EAAFBFB3B881C83EAB8EC029DA241A"),
    predecessor_bindings=(
        (_preview7.final_archive, 187305,
         "715ED188561505D1531FA903EC85EE742A34AE0A6646C9E61190D0D79FFD9513"),
        (_preview7.final_manifest, 976,
         "87296B9F800D3821437F9C15EB461522D5D790CB07EF5EA540E60C896F2E46BA")),
)
_preview9 = make_release_spec(
    "preview9", "0.1.0-preview.9",
    parent_ledger_binding=(2424,
        "B16FEDD0476E3505E16CC156451EC23849CF0840792250402A6E1E9EE0EC663D"),
    predecessor_bindings=(
        (_preview8.final_archive, 241170,
         "BCE2BC2D45CD34BE22C1EB481B13456494D9E46E7815F630A23E07BAEAA6734F"),
        (_preview8.final_manifest, 976,
         "175C4E5B5885759A105FD1F1844EED6D626641B60C940A25FF021E17216F6B96")),
)
_preview10 = make_release_spec(
    "preview10", "0.1.0-preview.10",
    parent_ledger_binding=(2660,
        "80ECF74FA5677087169D8C696D2C541386BD9FF9B3C8DE4ACCA59A7FAC6F43CC"),
    predecessor_bindings=(
        (_preview9.final_archive, 241760,
         "EE0805A69D80D81EA940755F19D2C54466F5EDB22F81A7C8BED4633581C9A850"),
        (_preview9.final_manifest, 976,
         "5B498173ACCDD8C4128B53462C2D59A2AAF47B8A9993A6B1188EFE7E338344FF")),
)
RELEASE_SPECS: Mapping[str, ReleaseSpec] = MappingProxyType({
    ...
    _preview7.id: _preview7,
    _preview8.id: _preview8,
    _preview9.id: _preview9,
    _preview10.id: _preview10,
})
...
PREVIEW10_SPEC = RELEASE_SPECS["preview10"]
